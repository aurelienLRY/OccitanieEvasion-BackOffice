...
* @param label : boolean
*/
export function GlobalPriceBadge({ price, label = true, className }: { price: number, label?: boolean, className?: string }) {
  return (
...
* @param label : boolean
*/
export function CustomerPriceBadge({price , label = true }:{price:number, label? :boolean}) {
  return (
...
export function StatusBadge({customerSession , className}:{customerSession: ICustomerSession, className?:string}) {
