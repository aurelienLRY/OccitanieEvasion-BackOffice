...
export const Modal = ({ isOpen, onClose, children }: Props) => {
  ...
  return (
    <>
      {/*overlay*/}
      <div
        className={`fixed inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex justify-center items-center z-30  ${
          isOpen ? "block" : "hidden"
        }`}
      >
        {/*modal*/}
        <div className="min-w-[300px] w-fit lg:max-w-[70vw] max-h-[90vh] overflow-y-auto bg-gray-800 dark:bg-sky-950 rounded-md shadow-md shadow-slate-400 dark:shadow-sky-400 z-50">
