 ...
 */
 export const  customerIsCancelled = (data : ICustomerSession[]) => data.every(
 ...
 interface StatusDisplay {
   ...
   */
  export function countAllWaitingCustomers(sessions: ISessionWithDetails[]): number {
    return sessions.reduce((count, session) => {
      return count + session.customerSessions.reduce((subCount, customerSession) => {
